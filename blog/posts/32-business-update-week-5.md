...
1. ❌ *Get 10 people using my tool in some capacity (even if they just try it and tell me “this isn’t useful to me”). Included in this is “market my product in some way to complete strangers”*
2. *Continue improving my tool, in particular:*

  1. ✅ *add support for multiple decks per user that you can switch between*
  2. ❌ *add tool to generate audio for any text (for listening comprehension practice)*
  3. ❌ *improve single-word translations - significant bug with this right now that I need to fix*
  4. ❌ *add articles / roots / parts of speech for at least a few languages*

3. ✅ *Research one of the “paying audience” ideas I have and talk to someone with direct knowledge of that audience*
